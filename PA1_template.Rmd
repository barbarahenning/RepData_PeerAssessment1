...
```{r loadpacks, echo=FALSE, warning=FALSE}
#setwd('/Users/barbarahenning/Google Drive Unicamp/DataScienceCoursera/Courses/5_ReproducibleResearch/Week2_MarkdownKnitr/finalProject')
library(ggplot2)
library(knitr)
...
**Answer:** The mean of the total number of steps taken per day is 10766.19 and the median is `r medianSteps`.
...
**Answer:** The 5-minute interval, on average across all the days in the dataset, that contains the maximum number of steps is `r meanInterval[which.max(meanInterval$steps),]$interval`.
...
**Answer:**  The total number of missing values in the dataset is `r totalMissing`.
             The new dataset is the *imputdata*.

```{r histoImput, fig.path = "figures/"}
